...
import time
import numpy as np
from CNNDataset import process_data
...
class DemographicBERT(nn.Module):
    def __init__(self, demographic_size):
        ...
        self.bert = EncoderDecoderModel.from_encoder_decoder_pretrained('bert-base-uncased','bert-base-uncased')
...
model.load_state_dict(torch.load('weights/BERT2BERT.pt'))
model.eval()
